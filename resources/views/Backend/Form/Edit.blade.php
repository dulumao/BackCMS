...
<head>
    <meta charset="UTF-8">
    <title>表单编辑 - {{ $config['web_name'] }}</title>
                    ...
                    <div class="uk-width-medium-1-2">
                        <div class="app-panel">
                            ...
                            <div class="uk-form-row">
                                <input class="uk-width-1-1 uk-form-large" type="text" placeholder="表单名称" required name="name" value="{{ $formField->name }}">
                            </div>

                            <div class="uk-form-row">
                                <input class="uk-width-1-1 uk-form-large" type="text" placeholder="表单接收器名称 Plugin/Form" name="plugin" value="{{ $formField->plugin }}" v-model="plugin" @keyup="update">
