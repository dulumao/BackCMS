...
<head>
    <meta charset="UTF-8">
    <title>单页编辑 - {{ $config['web_name'] }}</title>
                            ...
                            <div class="engine">
                                <div class="uk-htmleditor uk-clearfix">
                                    <div class="uk-margin uk-clearfix">
                                        ...
                                        <div class="uk-button-dropdown uk-float-right"
                                             data-uk-dropdown="{pos:'top-right'}" aria-haspopup="true"
                                             aria-expanded="false">
                                    ...
                                    <textarea v-model="form.body" style="display: none;" id="editor"></textarea>
                                </div>
                            </div>
                        </div>
                        <br>
...
<script>
    $(function () {
        ...
        var vm = new Vue({
            ...
            ready: function () {
                this.$http().success(function (page) {
                    this.form.title = page.title;
                    this.form.body = page.body;
                    this.form.enabled = page.enabled;
                    this.form.engine = page.engine;
//                    var editor = $('.CodeMirror')[0].CodeMirror;
//                    editor.setValue(this.form.body);
