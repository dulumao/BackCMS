...
<head>
    <meta charset="UTF-8">
    <title>模版创建 - {{ $config['web_name'] }}</title>
                    ...
                    <div class="uk-width-medium-1-2">
                        <div class="app-panel">
                            ...
                            <div class="uk-form-row">
                                <input class="uk-width-1-1 uk-form-large" type="text" placeholder="模版名称" required name="name">
                            </div>
                            ...
                            <div class="uk-form-row">
                                ...
                                <div class="uk-button-group">
                                    <button type="submit" class="uk-button uk-button-primary uk-button-large" :disabled="disabled">创建</button>
                                    <a href="{{ Action('Backend\TemplateController@getIndex') }}" class="uk-button uk-button-large">取消</a>
                                </div>
                                &nbsp;
                            </div>
                    ...
                    <div class="uk-width-medium-1-2">
                        <div class="uk-margin">
                            ...
                            <div class="uk-alert uk-alert-info">
                                ...
                                <div class="uk-button-dropdown" data-uk-dropdown="{pos:'top-right'}" aria-haspopup="true" aria-expanded="false">
